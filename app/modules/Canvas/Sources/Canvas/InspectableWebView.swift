...
public struct InspectableWebView: NSViewRepresentable {
  ...
  /// State for the experimental Canvas-hosted inspector pane.
  public var inspectorPaneState: CanvasInspectorPaneState? = nil
  /// Called when the experimental inspector pane emits a change.
  public var onInspectorPaneChange: ((CanvasInspectorChange) -> Void)?
  ...
  public init(
    ...
    inspectorPaneState: CanvasInspectorPaneState? = nil,
    onInspectorPaneChange: ((CanvasInspectorChange) -> Void)? = nil,
    ...
    self.inspectorPaneState = inspectorPaneState
    self.onInspectorPaneChange = onInspectorPaneChange
  ...
  public func updateNSView(_ webView: WKWebView, context: Context) {
    ...
    if context.coordinator.lastInspectorPaneState != inspectorPaneState {
      ElementInspectorBridge.updatePaneState(in: webView, state: inspectorPaneState)
      context.coordinator.lastInspectorPaneState = inspectorPaneState
    }
  }
  ...
  public class Coordinator: NSObject, WKNavigationDelegate, WKScriptMessageHandler {
    ...
    var lastInspectorPaneState: CanvasInspectorPaneState?
    ...
    init(parent: InspectableWebView) {
      ...
      self.lastInspectorPaneState = parent.inspectorPaneState
    }
    ...
    public func webView(_ webView: WKWebView, didFinish navigation: WKNavigation!) {
      ...
      ElementInspectorBridge.updatePaneState(in: webView, state: parent.inspectorPaneState)
    }
    ...
    public func userContentController(
      ...
      if let messageType = body["type"] as? String, messageType == "paneChange" {
        guard let change = ElementInspectorBridge.parsePaneChange(body) else { return }
        Task { @MainActor in
          parent.onInspectorPaneChange?(change)
        }
        return
      }
